...
<TABLE width=400 border="0" align=center cellpadding=4 cellspacing=1 class="tableBorder">
	<TR height=25><Th align=center><B class="whitetitle">部门编辑成功</B></Th>
	</TR>
	<TR><TD align=center><BR>
	  本页面将在<b><span id=yu>3</span><a href=javascript:countDown></a></b>秒后自动返回部门管理页面，您可以选择以下操作：<BR><BR>
	<li><a href="main.jsp">返回首页</a></li><br>
	<li><a href='class_edit.jsp?id=<%=id%>'>继续编辑部门</a></li><br>
	<li><a href="class_manage.jsp">返回部门管理页面</a></li>
	</TD></TR>
</TABLE>
