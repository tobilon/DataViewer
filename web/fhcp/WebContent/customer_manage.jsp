...
$("document").ready(function() { 	
  ...
  $('#flex1').flexigrid({
    ...
    { display: '公司', name: 'actor', width: 60, sortable: true, align: 'left' },
    ...
    { display: '客户备注', name: 'other', width: 80, sortable: true, align: 'left' },
    { display: '业务编号', name: 'service', width: 60, sortable: true, align: 'left' }
    ],     
    searchitems : [
