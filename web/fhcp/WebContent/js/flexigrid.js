		...
		if (p.usepager) {
			...
			if (p.searchitems) {
				...
				$(g.s1Div).append("<div class='s1Div2'>" +
						...
						"&nbsp;年龄&nbsp;"+"<input type='text' value='' size='11' name='cage1' class='qsbox' onClick='calendar()'/>--"+
						"<input type='text' value='' size='11' name='cage2' class='qsbox' onClick='calendar()'/>"+
						"&nbsp;职位&nbsp;"+"<input type='text' value='' size='10' name='ctitle' class='qsbox' /><br><br>"+
						"&nbsp;省份&nbsp;"+"<input type='text' value='' size='10' name='cprovince' class='qsbox' />" +
						"&nbsp;城市&nbsp;"+"<input type='text' value='' size='10' name='ccity' class='qsbox' />"+
						...
						"&nbsp;业务发生时间&nbsp;"+"<input type='text' value='' size='20' name='cservtime' class='qsbox' onClick='calendar()'/>&nbsp;&nbsp;<image name='servid' src='images/find.png' style='cursor: hand' alt='查看业务详情' />"+
				...
				$('input[name=advsearchbtn]', g.s1Div).click(function (){
					...
					p.cprovincevalue = $('input[name=cprovince]', g.s1Div).val();
				    p.ccityvalue = $('input[name=ccity]', g.s1Div).val();
