/*日期且包含时间至秒 例如：2010-2-14  10:10:10 */
/*
       1、head中引用 <script src="/js/Datepicker.js" type="text/javascript"></script>
       2、需要填写日期的地方<input type="text"  onclick="calendar();"/>
*/
